...
- **Hello World apps don't disappear after upgrade** — the green-field migration step's idempotency check is too eager. See [issue #69](https://github.com/ConductionNL/buildiq/issues/69).
- **Icons return 404 from `/apps/buildiq/icons/{slug}.svg`** — see [issue #68](https://github.com/ConductionNL/buildiq/issues/68).
