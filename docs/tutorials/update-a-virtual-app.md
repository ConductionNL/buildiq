...
> **Known issue**: the development pill doesn't yet render alongside Production in some scenarios — see [issue tracker](https://github.com/ConductionNL/buildiq/issues) for the latest.
