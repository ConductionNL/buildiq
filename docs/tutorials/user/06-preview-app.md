...
1. From the page designer, click **Save & open preview**. Alternatively, from a virtual app's detail page click **Open virtual app**, or hit `/apps/buildiq/builder/\<slug\>` directly.
