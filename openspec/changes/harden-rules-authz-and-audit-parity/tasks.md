...
- [x] 6.1 Register this change in the five capability specs (`business-rules-engine`, `buildiq-rbac`, `buildiq-exporter`, `application-insights`, `app-icon-management`): add to the `OpenSpec changes` list and set status `in-progress`.
