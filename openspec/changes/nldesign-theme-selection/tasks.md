...
- [ ] 1.1 **Define `runtime.theme` and validate it app-side**
...
- [ ] 2.1 **Implement src/dialogs/ThemePickerDialog.vue**
...
- [ ] 2.2 **Theme section on the application-detail/designer surface**
...
- [ ] 3.1 **Implement src/composables/useAppTheme.js — fetch, rewrite, inject, teardown**
...
- [ ] 3.2 **Scope attribute on the virtual-app runtime host + applier wiring**
...
- [ ] 4.1 **Playwright e2e: pick, preview, scoped render, absence**
...
- [ ] 4.2 **Newman: pin the nldesign asset contract**
