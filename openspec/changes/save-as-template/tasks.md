...
- [ ] 1.1 **Implement src/services/templateCapture.js — capture + de-namespace**
...
- [ ] 1.2 **OR write path: create / update-in-place via useObjectStore**
...
- [ ] 2.1 **Implement src/dialogs/SaveAsTemplateDialog.vue**
...
- [ ] 2.2 **"Save as template" action on the application-detail surface**
...
- [ ] 3.1 **Org-local badge + Edit-metadata/Delete actions in the gallery**
...
- [ ] 4.2 **Newman: pin the OR-level template contracts**
  - spec_ref: REQ-SAT-004, REQ-SAT-006
