...
# external-form-provisioning Specification

**OpenSpec changes**: [external-form-provisioning](../../changes/external-form-provisioning/)
...
byte-identical manifests to before this feature (purely additive).
...
<!-- @e2e exclude serialization-regression assertion, covered by vitest. -->
...
<!-- @e2e exclude pure conditional-rendering state, covered by vitest. -->
...
<!-- @e2e exclude pure request-shape assertion, covered by vitest. -->
