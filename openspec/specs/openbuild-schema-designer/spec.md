...
# buildiq-schema-designer Specification
...
The Buildiq schema designer SHALL render a list of schemas scoped to
the current virtual app's OpenRegister register namespace. The list
SHALL be reached at `/index.php/apps/buildiq/builder/{slug}/schemas`
