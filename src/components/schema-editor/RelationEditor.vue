		...
		<ul v-else class="openbuild-relation-editor__rows">
			<li
				...
				<NcTextField
					...
					@update:model-value="updateRelation(index, 'name', $event)" />
				<NcSelect
					...
					label="label"
					track-by="value"
					@update:model-value="updateRelation(index, 'target', $event ? $event.value : '')" />
				<NcSelect
					...
					label="label"
					track-by="value"
					@update:model-value="updateRelation(index, 'cardinality', $event ? $event.value : 'one')" />
				<NcTextField
					:model-value="relation.inverseOf || ''"
					:label="t('openbuild', 'Inverse-of (optional)')"
					@update:model-value="updateRelation(index, 'inverseOf', $event)" />
				<NcButton
					type="error"
