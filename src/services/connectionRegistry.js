 ...
 * 3.0.0 ships neither formatter, so Buildiq carries this copy until a
 ...
 * the module runs under vitest with nothing mocked.
 *
 ...
 */
export const INTEGRIQ_CONNECTIONS_PATH = '/apps/integriq/connections?app=buildiq&link=1'
