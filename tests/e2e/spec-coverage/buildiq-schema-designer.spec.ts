...
/**
 * E2E coverage for buildiq-schema-designer spec — UI scenarios only.
 *
 ...
 *
 * Note: The schema designer route is /apps/buildiq/builder/:slug/schemas
...
// @e2e buildiq-schema-designer::designer-lists-the-schemas-of-the-current-virtual-app
test('REQ-OBSD-001 — schema designer route renders for hello-world', async ({
	page,
}) => {
	// @e2e buildiq-schema-designer::designer-lists-the-schemas-of-the-current-virtual-app
	await page.goto(`${BASE}/apps/buildiq/builder/hello-world/schemas`)
...
// @e2e buildiq-schema-designer::schemas-from-other-virtual-apps-are-not-listed
test('REQ-OBSD-001 — schema designer scopes list to the target virtual app only', async ({
	...
	test.skip(
		!LIVE,
		'Requires live dev env with schema designer built and multiple apps — set BUILDIQ_E2E_LIVE=1',
	)
	...
	await page.goto(`${BASE}/apps/buildiq/builder/another-app/schemas`)
