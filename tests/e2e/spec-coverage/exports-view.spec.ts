...
/**
 * E2E coverage for the Buildiq Exports index page (manifest page
...
// stale; live-verified http://localhost:8099/apps/buildiq/exports renders
// the Exports view directly, no #/ fragment).
const ROUTE = `${BASE}/apps/buildiq/exports`

test.describe('Buildiq Exports view', () => {
	test('renders the Exports index surface and the Add Export Job action', async ({
		...
		// than an Exports defect, and CnIndexPage is nc-vue's, not Buildiq's.
