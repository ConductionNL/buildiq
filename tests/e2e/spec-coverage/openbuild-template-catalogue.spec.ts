...
/**
 * E2E coverage for openbuilt-template-catalogue spec — UI scenarios only.
 *
 ...
 *
 * Note: gallery tests guard on OPENBUILT_E2E_LIVE because the template
...
// @e2e openbuilt-template-catalogue::filtering-by-category-narrows-the-gallery
test('REQ-OBTC-003 — template gallery route renders at /apps/openbuilt/templates', async ({ page }) => {
	// @e2e openbuilt-template-catalogue::filtering-by-category-narrows-the-gallery
	await page.goto(`${BASE}/apps/openbuilt/templates`)
...
// @e2e openbuilt-template-catalogue::empty-application-list-surfaces-the-gallery-cta
...
// @e2e openbuilt-template-catalogue::clone-redirects-into-the-page-editor
test('REQ-OBTC-006 — "Use this template" action is present on gallery cards', async ({ page }) => {
	// @e2e openbuilt-template-catalogue::clone-redirects-into-the-page-editor
	test.skip(!LIVE, 'Requires live dev env with template catalogue seeded — set OPENBUILT_E2E_LIVE=1')
...
// @e2e openbuilt-template-catalogue::gallery-hides-edit-controls-on-a-seeded-template
